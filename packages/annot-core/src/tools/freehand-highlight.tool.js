...
const MIN_POINTS = 2;
export class FreehandHighlightTool {
    id = TOOL_IDS.HIGHLIGHT;
    name = 'Highlight';
    cursor = 'crosshair';
    points = [];
    drawing = false;
    ...
    onPointerUp(evt, ctx) {
        ...
        const annotation = buildAnnotation(ctx.docId, ctx.pageIndex, 'highlight', ctx.author, style, geometry);
        this.reset();
...
//# sourceMappingURL=freehand-highlight.tool.js.map