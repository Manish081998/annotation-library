...
export type {
  ...
  Annotation,
  AnnotationDocument,
} from './model/annotation.model.js';
export {
...
export {
  pt,
  addPt, subPt, scalePt,
  distance, distanceSq, midPoint, clampPt,
  pointAngleDeg,
  rectFromPoints, rectCenter, rectContainsPoint,
  rectsIntersect, rectUnion, rectInflate, rectTranslate,
  rectResizeByHandle, rectHandlePoints,
  pointsBounds, pointToSegmentDistanceSq, simplifyPath,
  pointInEllipse, pointToEllipseEdgeDistanceSq,
  arrowHead,
