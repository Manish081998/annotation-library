...
export declare function screenRectToDoc(adapter: ViewportAdapter, screenRect: Rect, pageIndex: number): Rect;
//# sourceMappingURL=viewport-adapter.interface.d.ts.map